...
export const BODY_PUBLIC_SELECTION_CATALOG: readonly PublicBodyCatalogEntry[] = [
  ...
  entry({
    ...
    description: "Región escapular y dorsal superior",
    side: "both",
    surface: "posterior",
    category: "back",
    supportedCoverages: COMPLETE_ONLY,
  ...
  entry({
    ...
    description: "Región dorsal y lumbar",
    side: "both",
    surface: "posterior",
    category: "back",
    supportedCoverages: COMPLETE_ONLY,
  ...
  entry({
    id: "neck_front",
    shortLabel: "Cuello · Parte anterior",
    description: "Cara anterior del cuello",
    side: "center",
    surface: "anterior",
    category: "neck",
    supportedCoverages: COMPLETE_ONLY,
  ...
  entry({
    id: "neck_back",
    shortLabel: "Cuello · Parte posterior",
    description: "Cara posterior del cuello",
    side: "center",
    surface: "posterior",
    category: "neck",
    supportedCoverages: COMPLETE_ONLY,
  ...
  entry({
    ...
    description: "Lateral izquierdo del cuello",
    side: "left",
    surface: "lateral",
    category: "neck",
    supportedCoverages: COMPLETE_ONLY,
  ...
  entry({
    ...
    description: "Lateral derecho del cuello",
    side: "right",
    surface: "lateral",
    category: "neck",
    supportedCoverages: COMPLETE_ONLY,
