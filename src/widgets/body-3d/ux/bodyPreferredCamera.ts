...
const PREFERRED_VIEW_OVERRIDES: Readonly<Record<string, PreferredBodyView>> = {
  ...
  right_flank: "front-right",
  right_flank_region: "front-right",
  left_flank: "front-left",
  left_flank_region: "front-left",
  ...
  right_upper_arm: "front-right",
  left_upper_arm: "front-left",
  right_forearm: "right",
  left_forearm: "left",
  ...
  neck_front: "front",
  neck_back: "back",
  neck_left: "front-left",
  neck_right: "front-right",
  full_neck: "front-right",
  full_glutes: "back",
  left_glute: "back",
  right_glute: "back",
};
