...
import { AwardsHallOfFame } from "@/widgets/home/AwardsHallOfFame";
...
export function TrajectoryAwardsSection() {
  ...
  const openHall = (index: number | null = null) => {
    setFocusIndex(index);
    setHallOpen(true);
  };

  const handleOpenAward = (_award: Award, index: number) => {
    openHall(index);
  };
